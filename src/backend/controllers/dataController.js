...
// Get Latest Data by Device
const getLatestDataByDevice = async (req, res) => {
  try {
...
// Get Aggregated Data by Device
const getAggregatedDataByDevice = async (req, res) => {
  try {
    const deviceId = req.params.deviceId;
    const {
      start_date,
...
const getDataStatsOverview = async (req, res) => {
  try {
