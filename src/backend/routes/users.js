...
router.get("/stats/overview", authorizeRoles("admin"), userController.getUserStats);
router.get("/activity", authorizeRoles("admin"), userController.getUserActivityLog);

// User Management Routes
router.get("/", authorizeRoles("admin"), userController.getAllUsers);
router.post("/", authorizeRoles("admin"), validate(schemas.createUser), userController.createUser);
router.get("/:id", userController.getUserById);
router.put("/:id", validate(schemas.updateProfile), userController.updateUserProfile);
